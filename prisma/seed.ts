...
async function seedDatabase() {
  try {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      barbershops.push(barbershop); // contem o seguinte erro: Argument of type '{ id: string; name: string; address: string; phones: string[]; description: string; imageUrl: string; createdAt: Date; updatedAt: Date; }' is not assignable to parameter of type 'never'.ts(2345)
    }
